    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            ...
            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                <li class="nav-item">
                    <a class="nav-link {{ ($title == "Mahasiswa") ? 'active' : (($title == "Hasil Pencarian Data Mahasiswa") ? 'active' : (($title == "Import Data Mahasiswa") ? 'active' : (($title == "Tambah Data Mahasiswa") ? 'active' : ''))) }}"
                        aria-current="page" href="/">Mahasiswa</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link {{ ($title == "Prodi") ? 'active' : (($title == "Hasil Pencarian Data Prodi") ? 'active' : (($title == "Import Data Prodi") ? 'active' : (($title == "Tambah Data Prodi") ? 'active' : ''))) }}"
                        href="/prodi">Prodi</a>
                </li>
            </ul>
